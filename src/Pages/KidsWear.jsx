...
// Product data
const ProductsData = [
  { id: 1, img: Image1, title: "Casual Wear", description: "Comfortable and stylish everyday outfits for kids.", rating: 4 },
  { id: 2, img: Image2, title: "Printed Wear", description: "Vibrant prints for a bold fashion statement.", rating: 5 },
  { id: 3, img: Image3, title: "Shirts", description: "Versatile shirts perfect for casual or semi-formal occasions.", rating: 4 },
  { id: 4, img: Image4, title: "Toys", description: "Engaging and fun toys for kids of all ages.", rating: 5 },
  { id: 5, img: Image5, title: "Action Toys", description: "Exciting action figures and collectibles.", rating: 4 },
  { id: 6, img: Image6, title: "Educational Toys", description: "Toys that combine fun with learning.", rating: 5 },
  { id: 7, img: Image7, title: "Clothing Sets", description: "Stylish and matching clothing sets for kids.", rating: 4 },
  { id: 8, img: Image8, title: "Winter Wear", description: "Keep your kids warm with our cozy winter collection.", rating: 4 },
  { id: 9, img: Image9, title: "Summer Wear", description: "Breathable and light outfits for hot days.", rating: 5 },
  { id: 10, img: Image10, title: "Dresses", description: "Elegant and comfortable dresses for all occasions.", rating: 4 },
  { id: 11, img: Image11, title: "Party Wear", description: "Trendy outfits for special celebrations.", rating: 5 },
  { id: 12, img: Image12, title: "Festive Wear", description: "Traditional yet modern outfits for festive moments.", rating: 4 },
];

const KidsWear = ({ setOrderPopup }) => {
  return (
    <>
      <Navbar />
