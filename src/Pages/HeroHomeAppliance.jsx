...
import Image1 from "../assets/heroHomeAppliance/homeappliances.png";
import Image2 from "../assets/heroHomeAppliance/sale.png";
...
const ImageList = [
  {
    id: 1,
    img: Image1,
    title: "Upto 50% off on HomeAppliance",
    description:
  ...
  },
  {
    id: 2,
    img: Image2,
    title: "Grab up to 70% off on trendy HomeAppliance",
    description:
      "Exclusive deals on HomeAppliance's fashion! including shirts, trousers, jackets, and more. Refresh your wardrobe with premium styles at pocket-friendly prices. Hurry, offer valid for a limited time!",
  },
];

const HeroHomeAppliance = () => {
  const settings = {
    dots: false,
    arrows: false,
    infinite: true,
...
export default HeroHomeAppliance;
