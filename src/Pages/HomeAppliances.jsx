...
import HeroHomeAppliance from './HeroHomeAppliance';

const ProductsData = [
  { id: 1, img: home1, title: "Washing Machine", description: "Efficient and powerful washing machine for spotless clothes.", rating: 4, price: 12999 },
  { id: 2, img: home2, title: "Refrigerator", description: "Keep your food fresh with this energy-efficient refrigerator.", rating: 5, price: 20999 },
  { id: 3, img: home3, title: "Microwave Oven", description: "Quick and easy cooking with our high-performance microwave.", rating: 4, price: 8999 },
  { id: 4, img: home4, title: "Blender", description: "Blend smoothies and soups with ease using this versatile blender.", rating: 5, price: 2999 },
  { id: 5, img: home5, title: "Air Conditioner", description: "Stay cool and comfortable with our energy-saving air conditioner.", rating: 4, price: 35999 },
  { id: 6, img: home6, title: "Dishwasher", description: "Save time and effort with this efficient dishwasher for spotless dishes.", rating: 5, price: 44999 },
  { id: 7, img: home7, title: "Electric Kettle", description: "Boil water in minutes with our fast and safe electric kettle.", rating: 4, price: 1999 },
  { id: 8, img: home8, title: "Vacuum Cleaner", description: "Keep your home clean and dust-free with this powerful vacuum cleaner.", rating: 4, price: 12999 },
  { id: 9, img: home9, title: "Coffee Maker", description: "Brew fresh coffee every morning with our sleek and easy-to-use coffee maker.", rating: 5, price: 4999 },
];
